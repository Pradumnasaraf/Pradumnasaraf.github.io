...
Docker Compose profiles make this easy. It saves us from of creating multiple compose file with different configurations and managing them. We this approach we can achieve single source file as a single source of truth.
