...
1. **Customizing Dockerfile Name and Path:** We can easily customize the name and directory of our Dockerfile using the context and Dockerfile options in Docker Compose. By default, Docker Compose looks for a Dockerfile named Dockerfile in the root directory of the context.
    ...
    ![Compose file snippet with the build block highlighted, setting a custom context directory and Dockerfile name](/blog-images/docker-compose-tips/image-01.jpeg)
...
2. **Using .env File in Docker Compose:**
    ...
    ![Compose file snippet with the env_file key highlighted, pointing the service at a .env file](/blog-images/docker-compose-tips/image-02.png)
...
3. **Building Images with Docker Compose:**
    ...
    ![Code snippet of the docker compose build command](/blog-images/docker-compose-tips/image-03.jpeg)
...
4. **Restart Policy:**
    ...
    ![Compose file snippet with the image key highlighted, pinning the service to a specific image tag](/blog-images/docker-compose-tips/image-04.jpeg)
...
5. **Assigning Container Names:**
    ...
    ![Compose file snippet with the container_name key highlighted, giving the service a fixed container name](/blog-images/docker-compose-tips/image-05.png)
...
6. **Depends on Property:**
    ...
    ![Compose file snippet with the depends_on key highlighted, making the app service wait on the database service](/blog-images/docker-compose-tips/image-06.png)
