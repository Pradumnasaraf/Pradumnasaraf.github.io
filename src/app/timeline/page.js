        ...
        <div className="timeline">
          ...
          >
            ...
            <div className="text-box">
              ...
              <p>
                ...
                Supply Chain Security and how to improve it by using Docker
                Scout in the CI/CD pipeline. Withough any doubt, this was the
                best talk I have ever delivered.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          </div>
          ...
          >
            ...
            <div className="text-box">
              ...
              <p>
                ...
                helpful in backend development like building APIs. This is
                longest blog I have ever written with 4k words and a whopping ~
                18 min read time.
              </p>
              <span className="right-container-arrow"></span>
            </div>
          ...
          <div className="container left-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                people from companies like Google, Microsoft, Amazon and more.
                Even some are using it as a reference in their interviews.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container left-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                houseful and it was a unforgettable experience.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container left-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                this was my first time hosting an event. I co-hosted the event
                with another Postman Student Leader.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container left-container">
            ...
            <div className="text-box">
              ...
              <small>May, 2022</small>
              <p>
                open-source-with-pradumna repository reached 100 stars on
                GitHub. This was huge because I never expected that my
                repository would help people get started with open source and
                hit 100 stars.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          ...
          <div className="container right-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                retained my position as an ambassador for next batch as well.
              </p>
              <span className="right-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container right-container">
            ...
            <div className="text-box">
              ...
              <small>April, 2022</small>
              <p>
                Open Source With Pradumna started as a 15-day bootcamp of
                Twitter post (Threads) where I was sharing my journey of open
                source and how to get started with it. This was a turning point
                for me. Fun fact: It all started from no where. I was in the bed
                rest as I screwed my food with a bike accident and have nothing
                to do. After this my social media presence grow and a lot of
          ...
          <div className="container left-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                Also I got mentioned in the Newsletter.
              </p>
              <span className="left-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container right-container">
            ...
            <div className="text-box">
              ...
              <p>
                ...
                present our project to the Postman team.
              </p>
              <span className="right-container-arrow"></span>
            </div>
          </div>
          ...
          <div className="container right-container">
            ...
            <div className="text-box">
              ...
              <p>
                First time I got a mention in a Newsletter. It was from
                EddieHub. I was mentioned for congratulating me becoming a
