        ...
        <div className="cv-content">
            ...
            <div className="job">
              ...
              <ul>
                <li>
                  ...
                  writing blogs, videos, and speaking at events.
                </li>
          ...
          <section className="section">
            ...
            <div className="project">
              ...
              <p>
                A Python-based MCP server that integrates the AviationStack API
                to provide real-time and historical flight data via structured
                endpoints. Analyzes flight delays by comparing scheduled and
                actual arrival/departure times. Packaged on PyPI as a server
                with endpoints compatible with any MCP-enabled LLM client or
                automation stack.
              </p>
              <p>
            ...
            <div className="project">
              ...
              <p>
                A Node.js service that connects GitHub Webhooks with the
                Permit.io access control platform. Listens to GitHub repository
                events and translates them into structured data for real-time
                authorization management. Uses Redis to persist incoming webhook
                events and retries failed syncs every 5 minutes, ensuring
                reliability even if Permit.io or the server is temporarily
                unavailable.
              </p>
              <p>
                <strong>Tech Stack:</strong> Node.js, Express.js, GitHub
                Webhooks, Redis, Permit.io SDK/API
              </p>
              <a
            ...
            <div className="project">
              <h3>Contributors</h3>
              <p>
                A GraphQL API built with Golang to capture and manage open
                source contribution data. Uses MongoDB for data storage and
                Redis for caching and rate limiting. Utilizes Prometheus and
                Grafana for monitoring, with custom metrics to track performance
                and usage. Deployed on Kubernetes for orchestration,
                scalability, and stateful workloads.
              </p>
              <p>
            ...
            <div className="achievements">
              <ul>
                <li>
                  ...
                  for outstanding community leadership and technical
                  contributions in the field of DevOps and Open Source.
                </li>
                <li>
            ...
            <div className="talks">
              <ul>
                ...
                <li>
                  ...
                  about Docker Compose and the importance of preview
                  environments.
                </li>
                <li>
                  Speaker at{' '}
